...
public:
    ...
    double Perimeter() {
        double perimeter = Side(x1, y1, x2, y2);
        perimeter += Side(x2, y2, x3, y3);
        perimeter += Side(x3, y3, x4, y4);
        perimeter += Side(x4, y4, x1, y1);
        return perimeter;
    }
    double Square() {
    ...
    void Info() {
        ...
        cout << Diagonal(x1, y1, x3, y3) << ", ";
        cout << Diagonal(x2, y2, x4, y4) << endl;
